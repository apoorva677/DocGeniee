...
# Load the IIT dataset
data_path = "JEE_Rank_2016_2024.csv"
try:
    ...
    with tab1:
        ...
        st.write("### Changes in Average Closing Ranks Over Years")
        ...
        st.write("### Trend Analysis: Predicting Seat Intake Over Years")
    ...
    with tab2:
        ...
        if not filtered_data.empty:
            ...
            st.write("No data available for selected program and institute combination.")
    ...
    st.error("❌ Error: JEE_Rank_2016_2024.csv file not found!")
    st.write("Please ensure the CSV file is in the same directory as the Streamlit app.")
except Exception as e:
    st.error(f"❌ Error loading data: {str(e)}")
    st.write("Please check the data file format and try again.")
